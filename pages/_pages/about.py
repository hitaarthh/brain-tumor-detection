...
def main():
    ...
    cleaned using the [mask.py](https://github.com/hitaarthh/brain-tumor-detection/blob/main/model/mask.py)
    ...
    loaded using the [get_model(num)](https://github.com/hitaarthh/brain-tumor-detection/blob/f13044f11e797a90ed73b2bbe94ab7a7502f02f5/model/predictor.py#L24)
    ...
    and is hosted at [Streamlit App](https://share.streamlit.io/hitaarthh/brain-tumor-detection/main/app.py). 
    The source code is available at [GitHub](https://github.com/hitaarthh/brain-tumor-detection).
    """
