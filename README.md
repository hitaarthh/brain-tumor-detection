...
<p align="center"><img src="https://raw.githubusercontent.com/hitaarthh/brain-tumor-detection/main/logo/brain.png" width="10%" style="margin: 0px; transform: translateY(-50%)">
</p>
...
1. **Clone the repository:**
    ```sh
    git clone https://github.com/hitaarthh/brain-tumor-detection.git
